                ...
                "content" : [
                    {
                        quest:{
                            type: 'text',
                            content: 'Công cha nhu nui thai son Công cha nhu nui thai son Công cha nhu nui thai son Công cha nhu nui thai son Công cha nhu nui thai son Công cha nhu nui thai son Công cha nhu nui thai son Công cha nhu nui thai son Công cha nhu nui thai son Công cha nhu nui thai son Công cha nhu nui thai son Công cha nhu nui thai son'
                        },
                        answer:[
                            {
                                type: 'text',
                                content: 'Công Công Công Công Công Công Công Công Công Công Công Công'
                            },
                            {
                                type: 'text',
                                content: 'Công'
                    ...
                    },
                    {
                        quest:{
                            type: 'text',
                            content: 'Công cha nhu nui thai son'
                        },
                        answer:[
                            {
                                type: 'text',
