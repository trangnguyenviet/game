...
TVUB.End = function (game) {
    ...
    this.initState.prototype = {
        create: function () {
             ...
             * AVATAR
             * */
            _game.createUserInfo.apply(this, [this.getTextureAtlas("bgAvatar"), this.getTextureAtlas('avatar'), 10]);
            /*
             * RESULT
             * */
            ...
            this.tiger = this.createPlayer(["v_trai", "v_phai", "v_than", "v_dau", "v_bong"], [0, 0, 0, 1, 0]);
            this.tiger.x = 200;
            this.tiger.y = _game.hh + 80;
