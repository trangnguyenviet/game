...
TVUB.Home = function (game) {
    ...
    this.initState.prototype = {
        create: function () {
            ...
            // //luat choi
            this.txtRules = this.add.text(_game.hw, _game.hh - 200, _game.gameData.title || '', {
                font: "30px Arial",
                fill: "#000000",
                align: 'center',
                stroke: '#FFFFFF',
            ...
            this.tiger = _game.createAtlasObject.apply(this, [[
               {
                    ...
                    image: this.getTextureAtlas("bt_bong"),
                    animation: false
                }
            ]]);
            ...
            this.tiger.x = 200;
            this.tiger.y = _game.hh + 50;
            this.game.add.tween(this.tiger).to({y: _game.hh + 80}, 400, Phaser.Easing.Back.Out, true);
            ...
            this.game.add.tween(this.btnStart).to({y: _game.hh + 50}, 1000, Phaser.Easing.Back.Out, true);
